...
class UiDialog(object):
    ...
    def _setup_top_section(self):
        ...
        self.start_button = self._create_button("开始", (200, 75), (2, 3, 1, 1))
        self.stop_button = self._create_button("停止", (200, 75), (2, 4, 1, 1))

        # Add spacers
        self.top_grid.addItem(QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum), 0, 5, 1, 1)
        self.top_grid.addItem(QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum), 0, 0, 1, 1)
    ...
    def _setup_plot_section(self):
        ...
        self._set_expanding_size_policy(self.plot_widget)
    ...
    def _setup_bottom_section(self):
        ...
        self.bottom_layout.addItem(QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum))
    ...
    def _create_input_field(self):
        ...
        self._set_expanding_size_policy(input_field)
    ...
    def _create_button(self, text, size=(0, 0), grid_pos=None):
        ...
        if size[0]:
            ...
            self._set_fixed_size_policy(button)
        button.setText(text)
        if grid_pos:
            self.top_grid.addWidget(button, *grid_pos)
        return button

    def _set_expanding_size_policy(self, widget):
    ...
    def _set_fixed_size_policy(self, widget):
    ...
    def _configure_top_section_size(self):
        ...
        self._set_expanding_size_policy(self.top_section)
    ...
    def _configure_bottom_section_size(self):
        ...
        self._set_expanding_size_policy(self.bottom_section)
